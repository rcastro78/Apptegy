...
public class ThrashDetails extends Activity{
	ListView lst;
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    getMessageDetail(id);
	    lst = (ListView)findViewById(R.id.lvThrash);
	    GetMessageDetailsAdapter adapter = new GetMessageDetailsAdapter(ThrashDetails.this,array);
	...
	private void getMessageDetail(int id)
	{
		...
		String sql= "SELECT sender,recipient,message_date,body FROM thrash_message WHERE idMessage="+id;

...
import info.kodelogic.apptegy.Thrash.ThrashTask;
import info.kodelogic.apptegy.Sentbox.SentboxTask;
...
public class Thrash extends Activity{
	...
	ListView lst;
	  ...
	  private final static String SITE_URL = "http://www.kodelogic.info/api/v1/messages/trash.json";
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.thrash);
	    
	    list = (ListView)findViewById(R.id.lvThrash);
	      
	    new ThrashTask().execute("");
	    ...
	    list.setOnItemClickListener(new OnItemClickListener() {
	        public void onItemClick(AdapterView<?> parent, View view,
	                ...
	                Intent idetails = new Intent(Thrash.this,ThrashDetails.class);
	  ...
	  class ThrashTask extends AsyncTask<String, Integer, ArrayList<MessageDetails>> {
		    ...
		    protected void onPreExecute() {
		      super.onPreExecute();
		      progressDialog = new ProgressDialog(Thrash.this);
		    ...
		    protected void onPostExecute(ArrayList<MessageDetails> result) {
		      ListView list;
		      list = (ListView)findViewById(R.id.lvThrash);
		      GetMessageAdapter adapter = new GetMessageAdapter(Thrash.this,result);
	  ...
	  {
		  int rows=-1;
			 ApptegyDBHelper dbHelper = new ApptegyDBHelper(Thrash.this,null,1);
			 SQLiteDatabase db = dbHelper.getWritableDatabase();
			 String sql="DELETE FROM thrash_message";
			 try{
				 db.execSQL(sql);
				 rows=1;
			 }catch(Exception e)
			  ...
			  String rec, String sender)
	  {
		 ...
		 SQLiteDatabase db = dbHelper.getWritableDatabase();
		 body=body.replace("'", " ");
		 String sql="INSERT INTO thrash_message(idMessage,topic,body,message_date,recipient," +
